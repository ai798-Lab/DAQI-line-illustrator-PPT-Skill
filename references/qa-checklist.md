...
- The image works without any readable text.
- It has one dominant hand-drawn contour figure or hand.
- It contains one core prop and one clear theme metaphor.
...
- Relies on text to explain the idea.

## Simplification Moves

- Delete secondary props first.
- Replace several objects with one red rod, map, pin, crown, or signal.
- Turn details into loose contour lines.
- Enlarge empty space.
- Reduce dots and marks to three to six.
